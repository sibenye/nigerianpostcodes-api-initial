...
public class FindController
{
    ...
    {
        return this.findService.getRuralPostcodes(stateId, lgaId, town, district);
    }
    ...
    {
        return this.findService.getUrbanPostcodes(stateId, town, area, street);
    }
    ...
    {
        return this.findService.getFacilityPostcodes(stateId, lgaId, facility);
    }
